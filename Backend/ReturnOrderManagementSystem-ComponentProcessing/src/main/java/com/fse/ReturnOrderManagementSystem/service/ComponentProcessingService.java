...
public class ComponentProcessingService {
	...
	public List<String> makePayment(long requestId, long cardNumber, long creditLimit, double processingCharge) throws Throwable {
		List<String> response=new ArrayList();
		log.info("Payment");
		DefectiveComponentDetail request = defectiveComponentRepository.findById(requestId).orElseThrow(null);
